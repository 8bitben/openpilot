...
DAYS_NO_CONNECTIVITY_MAX = 365  # do not allow to engage after a week without internet // changed to 1yr because there are no more updates for this branch
DAYS_NO_CONNECTIVITY_PROMPT = 360  # send an offroad prompt after 4 days with no internet // extended see above
